...
#define PISTOL_HOLSTER_SOCKET_NAME							(TEXT("pistol_holster"))
#define R_COLLARBONE_ANIM_SOCKET_NAME						(TEXT("RCollarbone_anim"))
#define ROOT_JOINT_SOCKET_NAME								(TEXT("Root_Joint"))
#define WEAPON_HOLSTER_SOCKET_NAME							(TEXT("weapon_holster"))
#define WEAPON_HOLSTER_N_SOCKET_NAME(Index)					(*FString::Printf(TEXT("weapon_holster%u"), Index))
